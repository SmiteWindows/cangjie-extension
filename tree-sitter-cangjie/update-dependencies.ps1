...
# Run tests if not skipped
    if (-not $SkipTests) {
        ...
        # Run Rust tests
        Run-Command -Command "cargo test" -Description "Running Rust tests"
        
        # Generate and build parser to ensure everything works
        Run-Command -Command "tree-sitter generate" -Description "Generating parser"
        Run-Command -Command "tree-sitter build" -Description "Building parser" -AllowFailure $true
